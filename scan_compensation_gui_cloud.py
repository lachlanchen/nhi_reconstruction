...
Fixed numpy compatibility and compact layout
"""
...
class ScanCompensationGUI:
    ...
    def create_widgets(self):
        ...
        ttk.Label(param_frame1, text="Iterations:").grid(row=1, column=0, sticky="w")
        self.iterations_var = tk.IntVar(value=1000)
        ttk.Entry(param_frame1, textvariable=self.iterations_var, width=10).grid(row=1, column=1, padx=2)
    ...
    def create_3d_plot(self):
        ...
        try:
            ...
            if len(ts_sampled) > 0:
                ...
                # Title
                ax.set_title(f'3D Compensated Events (Spectral)\n'
