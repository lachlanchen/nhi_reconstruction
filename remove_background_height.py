...
def process_tensor(tensor_path, max_shift, reverse, sample_rate, output_dir, hist_steps, n_acc, kernel_size):
    ...
    height = tensor.shape[1]  # Updated to use height instead of width
    print("tensor: ", tensor.shape)
    tensor_shifter = TensorShifter(max_shift, height // sample_rate, reverse, crop=True)  # Updated
    ...
    if kernel_size > 1:
        ...
        smooth_shifted_tensor = shifted_tensor  # Ensure variable is defined
