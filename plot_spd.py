...
# def calculate_dominant_event(pos_count, neg_count, zero_count, pos_factor, neg_factor, epsilon=0.001):
#     all_counts = pos_count + neg_count + zero_count
#     if all_counts == 0:
#         return 0
#     # dominant_event = (pos_count * pos_factor - neg_count * neg_factor) / all_counts
#     pos_prob = max(pos_count / all_counts, epsilon)
#     neg_prob = max(neg_count / all_counts, epsilon)
#     dominant_event = np.log(pos_prob)*pos_factor - np.log(neg_prob)*neg_factor
#     return dominant_event
