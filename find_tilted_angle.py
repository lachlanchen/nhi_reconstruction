...
import argparse
import os
from integer_shifter import TensorShifter  # Ensure integer_shifter.py is in the same directory or correctly added to PYTHONPATH
...
def calculate_std_for_shifts(tensor, min_shift, max_shift, reverse, sample_rate):
    ...
    width = tensor.shape[2]  # The width from the tensor dimensions [time, height, width]
...
def main():
    ...
    figure_filename = f"std_plot_{args.min_shift}_to_{args.max_shift}_{reverse_str}_sample{args.sample_rate}.png"
