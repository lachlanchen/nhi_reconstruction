...
def parse_args():
    ...
    parser.add_argument('-i', '--input-file', dest='input_path',  help="Path to input RAW/DAT file")
    parser.add_argument('-o', '--output-dir', help="Path to csv output directory")
...
if __name__ == "__main__":
    args = parse_args()
    sequence_filename_raw = "E:/pythonProject/NeuroDH/data/evk/recording_2024-04-29_16-41-18.raw"
    args.input_path = sequence_filename_raw
    args.output_dir = "E:/pythonProject/NeuroDH/data/evk/"
    main(args)
