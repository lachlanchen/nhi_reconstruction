...
Enhanced with manual parameter input, optional training, view perspectives, and time stretch control
"""
...
class ScanCompensationGUI:
    def __init__(self, root):
        ...
        # View perspectives (from the provided code)
        self.view_settings = {
            "default": (30, -30),
            "vertical": (0, 90),
            "horizontal": (90, 0),
    ...
    def create_widgets(self):
        ...
        # Action buttons
        self.run_button = ttk.Button(action_frame, text="Run/Set Parameters", command=self.run_optimization)
        ...
        # View Perspective - Row 3, Column 2
        view_frame = ttk.LabelFrame(control_frame, text="View Perspective", padding=5)
        view_frame.grid(row=2, column=1, sticky="ew", padx=2, pady=2)
        ...
        view_combo.grid(row=0, column=1, padx=2)
    ...
    def create_3d_plot(self):
        """Create 3D scatter plot with perspective control"""
        # Clear previous plot
